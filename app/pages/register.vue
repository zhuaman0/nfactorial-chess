<template>
  <div class="min-h-screen bg-slate-950 flex">
    ...
    <!-- ── Right form panel (flipped: form on left, deco on right) ─────── -->
    <div class="w-full lg:w-1/2 flex items-center justify-center p-6 bg-slate-950 lg:bg-slate-900/50">
      <div class="w-full max-w-md">
        ...
        <div class="relative overflow-hidden bg-slate-900 border border-white/10 rounded-3xl p-8 shadow-2xl">
          <div class="absolute -top-16 -left-16 w-48 h-48 bg-orange-500/10 rounded-full blur-3xl pointer-events-none"></div>

          <div class="relative">
            <h2 class="text-3xl font-extrabold text-white mb-1">Join the Arena</h2>
            <p class="text-slate-400 text-sm mb-8">Create your account and start playing today</p>
            ...
            <form @submit.prevent="handleSubmit" class="flex flex-col gap-5">
              ...
              <div>
                ...
                <input
                  ...
                  class="w-full px-4 py-3 bg-slate-800/80 border border-white/10 rounded-xl text-white placeholder-slate-600 text-sm outline-none focus:border-orange-500/60 focus:ring-2 focus:ring-orange-500/20 transition-all"
                />
                <p class="text-slate-600 text-xs mt-1.5">Minimum 6 characters</p>
              </div>

              <p v-if="authStore.successMsg" class="text-emerald-400 text-sm text-center -mt-1">{{ authStore.successMsg }}</p>
            ...
            <p class="text-center text-sm text-slate-500 mt-6">
              ...
              <NuxtLink to="/login" class="text-orange-400 hover:text-orange-300 font-semibold transition-colors">Sign In</NuxtLink>
            </p>
          </div>
        </div>
    ...
    <div class="hidden lg:flex lg:w-1/2 relative overflow-hidden flex-col items-center justify-center p-16 bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950">
      ...
      <div class="absolute -bottom-20 -left-20 w-96 h-96 bg-amber-500/15 rounded-full blur-3xl pointer-events-none"></div>
      ...
      <div class="relative flex flex-col items-center text-center gap-8 max-w-md">
        ...
        <div>
          <h1 class="text-5xl font-extrabold text-white leading-tight">
            Your Journey <span class="text-orange-500">Starts Here</span>
          </h1>
          <p class="text-slate-400 text-lg mt-3 leading-relaxed">
            Join thousands of players competing every day.
          </p>
        </div>
...
const features = [
  { icon: '🏆', title: 'Global Leaderboard',   text: 'See where you rank among all players worldwide.' },
  { icon: '🔥', title: 'Daily Streak Rewards',  text: 'Play every day and earn bonus XP multipliers.' },
  { icon: '🤖', title: 'AI Chess Coach',        text: 'Get instant analysis and personalized tips.' },
]
