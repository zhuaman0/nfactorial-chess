<template>
  <div class="chess-piece select-none cursor-grab active:cursor-grabbing w-full h-full flex items-center justify-center p-1">
    <!-- White King -->
...
defineProps({
  type: {
    type: String as PropType<'p' | 'n' | 'b' | 'r' | 'q' | 'k'>,
    required: true
  },
  color: {
    type: String as PropType<'w' | 'b'>,
    required: true
  }
})
</script>
